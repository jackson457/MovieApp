                    ...
                    <div class="mt-8">
                        <a href="{{route('movies.show',$movie['id'])}}" >
                            <img src={{$movie['poster_path']}} class="hover:opacity-75 transition ease-in-out duration-150" >
                        </a>
                        <div class="mt-2">
                            <a href="{{route('movies.show',$movie['id'])}}" class="text-gray-400 text-lg mt-2">{{$movie['title']}}</a>
